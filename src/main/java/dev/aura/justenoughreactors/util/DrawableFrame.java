...
public class DrawableFrame implements IDrawable {
  ...
  private static void drawTexturedRectangle(int x, int y, float rotation) {
    Gui.drawModalRectWithCustomSizedTexture(
        x, y, 0, 0, renderSize, renderSize, renderSize, renderSize);
  }
  ...
  public void draw(Minecraft minecraft, int xOffset, int yOffset) {
    ...
    drawTexturedRectangle(x, y + shift1, 0);
    drawTexturedRectangle(x + shift1, y, 90);
    drawTexturedRectangle(x + shift2, y + shift1, 180);
    drawTexturedRectangle(x + shift1, y + shift2, 270);
